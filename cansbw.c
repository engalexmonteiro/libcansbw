...
int print_bw_iface(char *iface, host_interfaces_t* host_ifaces){
...
int print_bw_interface(int i, host_interfaces_t* host_ifaces, char* iface){
	...
	print_bw_iface(iface,host_ifaces);
